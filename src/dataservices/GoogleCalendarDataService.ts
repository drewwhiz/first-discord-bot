...
export class GoogleCalendarDataService implements IGoogleCalendarDataService {
  ...
  public async getAll(): Promise<IGoogleCalendar[]> {
  ...
  public async get(id: number): Promise<IGoogleCalendar> {
  ...
  public async add(calendarId: string): Promise<IGoogleCalendar> {
  ...
  public async update(id: number, updatedRecord: IGoogleCalendar): Promise<IGoogleCalendar> {
