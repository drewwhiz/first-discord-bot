...
export class ProgramDataService implements IProgramDataService {
  ...
  async insert(record: IProgramData): Promise<IProgramData> {
  ...
  async getAll(): Promise<IProgramData[]> {
  ...
  async update(id: number, updatedRecord: IProgramData): Promise<IProgramData> {
